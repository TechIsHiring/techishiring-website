...
const Hero = () => {
  return (
    <div className=" w-full h-full bg-[#eaeaea] ">
      <div className="w-full h-screen bg-[url('https://s3-alpha-sig.figma.com/img/be3d/4572/95d73f726199a6e31e24f7b63daa1a82?Expires=1676851200&Signature=pjRJnadNsA7JGPWF0d8EnX68CS5-ESV9OAd0EdcL1~htONJGvZ1nBHWGrlRbNAQ80z9gC08jPTGbyEMKXrigcAt~znkhh0m~vt~1cZ5mQVT97oSdzcqMtXaKT2uozddzXXRc2nW-X~viy5VSWcJmulFrEGN69RIufX0dcCxJAKr7tZjxFM7OMWeHXDTmNeu~Rys8B5Fr3nAoc8AobfMneyMgAA22mNTkU6AHTDFIWl0TAD7f494RUeFaX3meJ8AQcPx6yZkKn-y3V40C9lxryK18knov8ATO30rRjBk3ya8xmOjbZSBGBfY36Rb346HADSh2cM7uuDxvqF504Bvndw__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4')] bg-cover bg-center">
